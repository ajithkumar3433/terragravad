...
const Projects = () => {
  ...
  return (
    <div className="pt-10 w-full ">
      <div className={`text-3xl lg:text-5xl font-bold text-center mt-3 mb-5 cursor-pointer ${type===''?'text-blue-900':''}`} onClick={()=>setType('')}>Film</div>
      <div className="text-base font-normal text-[#1E1E1E] text-center mt-3 mb-10">
        Explore films and screenwriter plays  
      </div>
      <div className='hidden lg:flex justify-center mt-3 mb-20'>
        <div className='text-base text-[#1C2E63] flex'>
            <div className={`px-2 hover:text-[#905794] cursor-pointer ${type==='Video'?'font-bold':''}`} onClick={()=>changeType('Video')}>Explore Video</div>
            <div className={`px-2 hover:text-[#905794] cursor-pointer ${type==='Short Films'?'font-bold':''}`} onClick={()=>changeType('Short Films')}>Explore Short Films</div>
            <div className={`px-2 hover:text-[#905794] cursor-pointer ${type==='Animated Films'?'font-bold':''}`} onClick={()=>changeType('Animated Films')}>Explore Animated Films</div>
        </div>
      </div>
