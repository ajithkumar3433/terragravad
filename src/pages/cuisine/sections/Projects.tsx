...
const Projects = () => {
  ...
  }, [searchWord, type, currentPage, pageCount, dispatch])
  ...
  return (
    <div className="pt-10 w-full ">
      <div className={`text-3xl lg:text-5xl font-bold text-center mt-3 mb-5 cursor-pointer ${type===''?'text-blue-900':''}`} onClick={()=>setType('')}>Food</div>
      <div className="text-base font-normal text-[#1E1E1E] text-center mt-3 mb-10">
        Explore new innovative food ideas and breakthroughs 
      </div>
      {/* <div className='hidden lg:flex justify-center mt-3 mb-20'>
        <div className='text-base text-[#1C2E63] flex'>
            <div className={`px-2 hover:text-[#905794] cursor-pointer ${type==='Video'?'font-bold':''}`} onClick={()=>setType('Video')}>Explore Video</div>
            <div className={`px-2 hover:text-[#905794] cursor-pointer ${type==='Short Films'?'font-bold':''}`} onClick={()=>setType('Short Films')}>Explore Short Films</div>
            <div className={`px-2 hover:text-[#905794] cursor-pointer ${type==='Animated Films'?'font-bold':''}`} onClick={()=>setType('Animated Films')}>Explore Animated Films</div>
        </div>
      </div> */}
