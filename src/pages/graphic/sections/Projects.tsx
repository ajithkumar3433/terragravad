...
const Projects = () => {
  ...
  return (
    <div className="pt-10 w-full ">
      <div className={`text-3xl lg:text-5xl font-bold text-center mt-3 mb-5 cursor-pointer ${type===''?'text-blue-900':''}`} onClick={()=>setType('')}>Illustration</div>
      <div className="text-base font-normal text-[#1E1E1E] text-center mt-3 mb-10">
        Explore immersive pieces from illustrators with original story lines
      </div>
      <div className='hidden lg:flex justify-center mt-3 mb-20'>
        <div className='text-base text-[#1C2E63] flex'>
            <div className={`px-2 hover:text-[#905794] cursor-pointer ${type==='Comics'?'font-bold':''}`} onClick={()=>changeType('Comics')}>Explore Comics</div>
            <div className={`px-2 hover:text-[#905794] cursor-pointer ${type==='Cartoon'?'font-bold':''}`} onClick={()=>changeType('Cartoon')}>Explore Cartoon</div>
            <div className={`px-2 hover:text-[#905794] cursor-pointer ${type==='Fashion'?'font-bold':''}`} onClick={()=>changeType('Fashion')}>Explore Fashion</div>
            <div className={`px-2 hover:text-[#905794] cursor-pointer ${type==='Concept Art'?'font-bold':''}`} onClick={()=>changeType('Concept Art')}>Explore Concept Art</div>
            <div className={`px-2 hover:text-[#905794] cursor-pointer ${type==='Wood Art'?'font-bold':''}`} onClick={()=>changeType('Wood Art')}>Explore Wood Art</div>
        </div>
      </div>
