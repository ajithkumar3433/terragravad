...
const Projects = () => {
  ...
  return (
    <div className="pt-10 w-full ">
      <div className={`text-3xl lg:text-5xl font-bold text-center mt-3 mb-5 cursor-pointer ${type===''?'text-blue-900':''}`} onClick={()=>setType('')}>Publishing</div>
      <div className="text-base font-normal text-[#1E1E1E] text-center mt-3 mb-10">
        Explore new literature works and podcasts
      </div>
      <div className='hidden lg:flex justify-center mt-3 mb-20'>
        <div className='text-base text-[#1C2E63] flex'>
            <div className={`px-2 hover:text-[#905794] cursor-pointer ${type==='Journalism'?'font-bold':''}`} onClick={()=>changeType('Journalism')}>Explore Journalism</div>
            <div className={`px-2 hover:text-[#905794] cursor-pointer ${type==='Book Publishing'?'font-bold':''}`} onClick={()=>changeType('Book Publishing')}>Explore Book Publishing</div>
        </div>
      </div>
